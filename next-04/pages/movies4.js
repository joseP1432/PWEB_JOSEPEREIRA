...
class NameForm extends React.Component {
    ...
    render() {
        return (
            ...
            <label class="sr-only" for="inlineFormInputName2">Título</label>
            <input type="text" class="form-control mb-2 mr-sm-2" value={this.state.value} onChange={this.handleChange} placeholder="Digite o título..."/>
